  ...
  try {
    await Promise.all([
      ...
      createBoard({
        type: 'admin',
        subject: '관리자 게시판',
        createAuth: 'level,role',
        createLevel: 100,
        createRole: 'SPECIAL',
        readListAuth: 'level,role',
        readListLevel: 100,
        readListRole: 'SPECIAL',
        readAuth: 'level,role',
        readLevel: 100,
        readRole: 'SPECIAL',
        updateAuth: 'level,role',
        updateLevel: 100,
        updateRole: 'SPECIAL',
        deleteAuth: 'level,role',
        deleteLevel: 100,
        deleteRole: 'SPECIAL',
        likeAuth: 'level',
        likeLevel: 100,
        likeRole: '',
        useComment: true,
        commentCreateAuth: 'level,role',
        commentCreateLevel: 100,
        commentCreateRole: 'SPECIAL',
        commentReadListAuth: 'level,role',
        commentReadListLevel: 100,
        commentReadListRole: 'SPECIAL',
        commentDeleteAuth: 'level,role',
        commentDeleteLevel: 100,
        commentDeleteRole: 'SPECIAL',
        commentLikeAuth: 'level',
        commentLikeLevel: 100,
        commentLikeRole: '',
        fileCreateAuth: 'level,role',
        fileCreateLevel: 100,
        fileCreateRole: 'SPECIAL',
        fileReadAuth: 'level,role',
        fileReadLevel: 100,
        fileReadRole: 'SPECIAL',
        attachFileSize: 1024 * 1024 * 5,
        attachFileSizeTotal: 1024 * 1024 * 20,
        attachImageSize: 1024 * 1024 * 10,
      }),
